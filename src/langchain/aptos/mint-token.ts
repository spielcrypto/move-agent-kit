...
export class AptosMintTokenTool extends Tool {
	...
	This tool is used to mint new tokens to the current user's account.
	...
	Popular tokens that can be minted include:
	...
	MANDATORY RULE: You MUST ALWAYS create the transaction for the user to sign once they have agreed to mint tokens. 
