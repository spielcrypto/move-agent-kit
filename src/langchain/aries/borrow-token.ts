...
export class AriesBorrowTool extends Tool {
	name = "aries_borrow"
	description = `Borrow tokens from Aries lending protocol.
	...
	Popular tokens that can be borrowed include:
	...
	Examples:
	- "Borrow 1 native APT from Aries"
	- "Take out 100 native USDC from Aries"
	- "Borrow 0.1 lzWBTC from Aries lending"
