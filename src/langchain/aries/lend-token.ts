...
export class AriesLendTool extends Tool {
	name = "aries_lend"
	description = `Lend tokens to Aries lending protocol.
	...
	Popular tokens that can be lent include:
	...
	Examples:
	- "Lend 1 native APT to Aries"
	- "Supply 100 native USDC to Aries"
	- "Deposit 0.1 lzWBTC to Aries lending"
	- "Lend 100 whUSDC to Aries protocol"
