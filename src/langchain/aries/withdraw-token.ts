...
export class AriesWithdrawTool extends Tool {
	name = "aries_withdraw"
	description = `Withdraw lent tokens from Aries lending protocol.
	...
	Popular tokens that can be withdrawn include:
	...
	Examples:
	- "Withdraw 1 native APT from Aries"
	- "Take out 100 native USDC from Aries"
	- "Withdraw 0.1 lzWBTC from Aries lending"
	- "Get 100 whUSDC from Aries protocol"
