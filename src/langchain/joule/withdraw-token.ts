...
export class JouleWithdrawTokenTool extends Tool {
  ...
  Examples:
  - "I want to withdraw 0.5 native APT from my Joule position"
  - "Withdraw 10 native USDC from position 1234"
  - "Take out 2 lzWETH from Joule Finance"
  - "Withdraw 0.1 lzWBTC from my loan"
  - "Get 100 whUSDT from my Joule position"
  - "Withdraw 100 native USDC from the pool"
  - "Take out 1 native APT from my lending position"

	MANDATORY RULE: You MUST ALWAYS create the transaction for the user to sign once they have agreed to withdraw tokens. 
